...
TEXTS = {
    "ru": {
        ...
        "queue_empty": "📭 Очередь пуста. Сначала добавь трек через /add или кнопки поиска.",
        "queue_db_unavailable": "❌ База данных недоступна. Работа с очередью временно отключена.",
        "queue_playing": "🎧 <b>Запускаю из очереди:</b> {title}",
        "queue_skipped": "⏭️ <b>Пропущен трек:</b> {title}",
        "queue_next_up": "➡️ <b>Следующий в очереди:</b> {title}",
    ...
    "en": {
        ...
        "queue_empty": "📭 Your queue is empty. Add a track first with /add or from search buttons.",
        "queue_db_unavailable": "❌ Database is unavailable. Queue operations are temporarily disabled.",
        "queue_playing": "🎧 <b>Playing from queue:</b> {title}",
        "queue_skipped": "⏭️ <b>Skipped track:</b> {title}",
        "queue_next_up": "➡️ <b>Next in queue:</b> {title}",
    ...
    "tg": {
        ...
        "queue_empty": "📭 Навбат холӣ аст. Аввал сурудро бо /add ё аз натиҷаҳои ҷустуҷӯ илова кунед.",
        "queue_db_unavailable": "❌ Пойгоҳи додаҳо дастрас нест. Кори навбат муваққатан хомӯш аст.",
        "queue_playing": "🎧 <b>Аз навбат иҷро мешавад:</b> {title}",
        "queue_skipped": "⏭️ <b>Суруд гузаронида шуд:</b> {title}",
        "queue_next_up": "➡️ <b>Навбатии навбат:</b> {title}",
    ...
    "uz": {
        ...
        "queue_empty": "📭 Navbat bo'sh. Avval trekni /add yoki qidiruv tugmalari orqali qo'shing.",
        "queue_db_unavailable": "❌ Ma'lumotlar bazasi mavjud emas. Navbat amallari vaqtincha o'chirilgan.",
        "queue_playing": "🎧 <b>Navbatdan ijro etilmoqda:</b> {title}",
        "queue_skipped": "⏭️ <b>O'tkazib yuborildi:</b> {title}",
        "queue_next_up": "➡️ <b>Navbatdagi trek:</b> {title}",
